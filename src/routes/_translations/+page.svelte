<script lang="ts">
	...
	import LanguageList from '$lib/ui/components/LanguageList.svelte';
...
<svelte:head>
	...
	<meta name="description" content="Visual translation editor for .po files" />
</svelte:head>
...
<div class="flex h-screen flex-col bg-slate-50 dark:bg-slate-900">
	...
	<main class="flex flex-1 overflow-hidden">
		...
		<aside class="w-72 overflow-y-auto border-r border-slate-200 bg-white dark:border-slate-700 dark:bg-slate-800">
			<LanguageList bind:selected={selectedLanguage} apiBase="/_translations" />
		</aside>
